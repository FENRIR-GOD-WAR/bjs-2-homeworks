...
const sherlok = new PrintEditionItem(
...
console.log(sherlok.releaseDate);
console.log(sherlok.state); 
sherlok.fix();
console.log(sherlok.state);
...
console.log("Количество книг до выдачи: " + library.book.length);

console.log(library.giveBookByName("Машина времени"));
console.log("Количество книг после выдачи: " + library.book.length);
console.log(library);